...
# Part of Softhealer Technologies.
{
    ...
    'depends': ['mail','base_setup','spreadsheet','bus'],
    'data': [
    ...
    'assets': {
        'web.assets_backend': [            
            # 'sh_activities_management_basic/static/src/xml/filter_value.xml',
            # 'sh_activities_management_basic/static/src/js/filter_value.js',
            'sh_activities_management_basic/static/src/scss/crm_dashboard.scss',
            'sh_activities_management_basic/static/src/xml/dashboard_components/main_component.xml',  
            'sh_activities_management_basic/static/src/xml/dashboard_components/table_component.xml',  
            'sh_activities_management_basic/static/src/xml/dashboard_components/cards_component.xml',  
            'sh_activities_management_basic/static/src/js/dashboard_components/main_component.js',  
            'sh_activities_management_basic/static/src/js/dashboard_components/table_component.js',  
            'sh_activities_management_basic/static/src/js/dashboard_components/cards_component.js',  
        ],         
        # 'web.assets_frontend': [
        #     'sh_activities_management_basic/static/src/js/bootstrap-multiselect.js',
        #     'sh_activities_management_basic/static/src/js/bootstrap-multiselect.min.js',
        # ],
    },
